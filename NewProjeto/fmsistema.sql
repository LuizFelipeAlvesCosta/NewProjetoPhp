...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Jun-2020 às 21:46
...
CREATE TABLE `cliente` (
  ...
  `Bairro` varchar(455) DEFAULT NULL,
  `UF` varchar(455) DEFAULT NULL,
  `Cidade` varchar(455) DEFAULT NULL,
  `Telefone` varchar(455) DEFAULT NULL,
  `Obsoleto` varchar(3) DEFAULT NULL,
  `Vendedor` varchar(300) DEFAULT NULL,
...
INSERT INTO `cliente` (`Id`, `Nome`, `Email`, `Endereco`, `Bairro`, `UF`, `Cidade`, `Telefone`, `Obsoleto`, `Vendedor`, `Contato`, `Cep`) VALUES
(7, 'Luiz Felipe Alves Costa', 'Felipealves_98@hotmail.com', 'Travessa Santa Rosa  QD.A', 'teste de teste de teste ', '2', '103', '(82) 9884-27038', 'NÃO', '999.999.999-32', 'Jefferson Alexandre da silva xavier', '57.100-000'),
(8, 'Luiz Felipe Alves Costa', 'Felipealves_98@hotmail.com', 'Travessa Santa Rosa  QD.A', 'Antares', '2', '3', '(82) 9884-27038', 'NÃO', '021.456.786-35', 'Jefferson Alexandre da silva xavier', '57.100-000'),
(9, 'teste de cliente', 'teste@gmail.com', 'teste ', 'teste', '2', '5', '(82) 9635-63636', 'NÃO', '05263254863', '8296336262', '55.663-622'),
(10, 'Cliente do vendedor ', 'araldi@haija.com', 'Kkkk ', 'Centro ', '2', '147', '(22) 2222-22222', 'NÃO', '999.999.999-32', 'João pé de feijao', '56.775-677');

-- --------------------------------------------------------

--
-- Estrutura da tabela `condicao_pag`
--

CREATE TABLE `condicao_pag` (
  `Id` smallint(6) NOT NULL,
  `Tipo` varchar(80) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `condicao_pag`
--

INSERT INTO `condicao_pag` (`Id`, `Tipo`) VALUES
(1, '30/60/90'),
(2, '1 + 1'),
(3, '15/30'),
(4, '30 dias');
...
CREATE TABLE `estoque` (
  `Id` smallint(6) NOT NULL,
  `Qtd_Prod` varchar(4) DEFAULT NULL,
  `log` varchar(455) DEFAULT NULL,
...
INSERT INTO `estoque` (`Id`, `Qtd_Prod`, `log`, `Id_Prod`, `Unidade`) VALUES
(43, '60', 'Luiz Felipe Alves Costa', '29', '2'),
(44, '54.5', 'Luiz Felipe Alves Costa', '30', '3'),
(45, '37.5', 'Aralyne', '31', '4');
...
INSERT INTO `forma_pag` (`Id`, `Tipo`) VALUES
(1, 'Boleto'),
(2, 'Cheque'),
(3, 'A vista'),
(4, 'Cartão');
...
CREATE TABLE `fornecedor` (
  ...
  `Razao_social` varchar(455) DEFAULT NULL,
  `Nome_Fantasia` varchar(455) DEFAULT NULL,
  `Estado` varchar(50) DEFAULT NULL,
  `Municipio` varchar(50) DEFAULT NULL,
  `Cep` varchar(20) DEFAULT NULL,
  `Telefone` varchar(20) DEFAULT NULL,
  `Email` varchar(455) DEFAULT NULL,
  `Obsoleto` varchar(2) DEFAULT NULL,
...
INSERT INTO `fornecedor` (`Id`, `CNPJ`, `Razao_social`, `Nome_Fantasia`, `Estado`, `Municipio`, `Cep`, `Telefone`, `Email`, `Obsoleto`, `Contato`) VALUES
(1, '55.555.666/0001-88', 'Fornecedor 1', 'Fornecedor Teste 1', 'AL', 'Maceió', '57100-000', '82988886963', 'teste@gmail.com', '1', ''),
(2, '999.999.999-32', 'Teste Fornecedor', 'Teste Fornecedor', 'RJ', 'as', '57048-719', '828585855', 'aralynegs@gmail.com', '0', ''),
(3, '55.555.666/0001-88', 'Teste Fornecedor 2', 'Teste Fornecedor 2', 'AL', 'Maceió', '57048-000', '82829999999', 'teste@gmail.com', '0', ''),
(4, '198.819.89/0001-18', 'Teste Fornecedor 3', 'Teste Fornecedor 3', 'AL', 'Maceió', '57.048-719', '(82) 9999-9999', 'teste@gmail.com', '0', ''),
(8, '198.819.89/0001-18', 'Teste Fornecedor4', 'Teste Fornecedor4', 'AL', 'Maceió', '57.048-000', '(82) 9999-9999', 'TesteFornecedor4@gmail.com', '0', ''),
(9, '31.344.571/000', 'Fornecedor2', 'Fornecedor2', 'AC', 'cidade', '57038-000', '(99) 9999-9999', 'teste@teste.com', '0', ''),
(10, '31.344.571/000', 'Fornecedor', 'Fornecedor', 'AL', 'Maceió', '57.038-000', '(99) 9999-9999', 'teste@teste.com', '0', ''),
(11, '31.344.571/000', 'Fornecedor teste ti', 'Fornecedor teste ti', 'AL', 'Maceió', '57.038-000', '(99) 9999-9999', 'teste@teste.com', '0', ''),
(12, '11.111.111/1111-11', 'Teste Fornecedor 6596', 'Teste fantasia 6596', 'AL', 'Maceió', '57.100-000', '(82) 9896-2698', 'teste@gmail.com', '0', 'Felipe teste '),
(13, '11.111.111/1111-11', 'teste do numeros ', 'teste de numero', 'AL', 'Maceió', '57100-000', '(82) 9884-27038', 'Felipealves_98@hotmail.com', '0', 'Jefferson Alexandre da silva xavier');

-- --------------------------------------------------------

--
-- Estrutura da tabela `historico_alt_preco`
--

CREATE TABLE `historico_alt_preco` (
  `Id` smallint(6) NOT NULL,
  `log` varchar(455) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `historico_alt_preco`
--

INSERT INTO `historico_alt_preco` (`Id`, `log`, `data`, `preco`, `motivo`, `id_produto`) VALUES
(24, 'Luiz Felipe Alves Costa', '09/06/2020', '', '', 29),
(25, 'Luiz Felipe Alves Costa', '09/06/2020', '', '', 30),
(26, 'Luiz Felipe Alves Costa', '10/06/2020', '30,00', '', 31),
(27, 'Luiz Felipe Alves Costa', '10/06/2020', '35,00', 'teste 1 ', 0),
(28, 'Luiz Felipe Alves Costa', '10/06/2020', '25,90', 'teste 2 ', 30),
(29, 'Luiz Felipe Alves Costa', '10/06/2020', '30,00', 'teste 2 ', 29),
(30, 'Luiz Felipe Alves Costa', '10/06/2020', '12,50', 'teste 3 ', 31),
(31, 'Luiz Felipe Alves Costa', '10/06/2020', '18,63', 'teste 3 ', 31);
...
CREATE TABLE `historico_compra` (
  `Id` smallint(6) NOT NULL,
  `Id_Fornecedor` varchar(10) DEFAULT NULL,
  `Id_Produto` varchar(10) DEFAULT NULL,
  `Valor_Compra` varchar(15) DEFAULT NULL,
  `Qtd_Entrada` varchar(15) DEFAULT NULL,
  `Data_Compra` varchar(15) DEFAULT NULL,
  `NF` varchar(150) DEFAULT NULL,
  `Id_Compra` varchar(15) NOT NULL,
  `valor_unitario` varchar(12) DEFAULT NULL,
  `Unidade` varchar(80) DEFAULT NULL,
  `qtd_parcelas` varchar(15) DEFAULT NULL,
  `forma_pag` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `historico_compra`
--

INSERT INTO `historico_compra` (`Id`, `Id_Fornecedor`, `Id_Produto`, `Valor_Compra`, `Qtd_Entrada`, `Data_Compra`, `NF`, `Id_Compra`, `valor_unitario`, `Unidade`, `qtd_parcelas`, `forma_pag`) VALUES
(2058, '10', '29', '7500', '15', '10/06/2020', NULL, '00001', '500', '2', '2', '1'),
(2059, '10', '30', '200', '10', '10/06/2020', NULL, '00001', '20', '3', '2', '1');
...
CREATE TABLE `historico_vendas` (
  ...
  `Id_Vendedor` varchar(10) DEFAULT NULL,
  `Id_Form_Pag` varchar(10) DEFAULT NULL,
  `Id_Titulo_Recebe` varchar(10) DEFAULT NULL,
  `Valor_Prod_Venda` varchar(10) DEFAULT NULL,
  `Qtd_Venda` varchar(10) DEFAULT NULL,
  `Valor_Venda` varchar(10) DEFAULT NULL,
  `Data_Venda` varchar(20) DEFAULT NULL,
  `Desconto` varchar(10) DEFAULT NULL,
  `Valor_Desconto` varchar(10) DEFAULT NULL,
  `Valor_venda_sem_desconto` varchar(10) DEFAULT NULL,
  `Valor_Final_Venda` varchar(10) DEFAULT NULL,
  `Parcela_Venda` varchar(10) DEFAULT NULL,
  `Estorno` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `historico_vendas`
--

INSERT INTO `historico_vendas` (`Id`, `Id_Venda`, `Id_Prod`, `Id_Cliente`, `Id_Vendedor`, `Id_Form_Pag`, `Id_Titulo_Recebe`, `Valor_Prod_Venda`, `Qtd_Venda`, `Valor_Venda`, `Data_Venda`, `Desconto`, `Valor_Desconto`, `Valor_venda_sem_desconto`, `Valor_Final_Venda`, `Parcela_Venda`, `Estorno`) VALUES
(27, '00001', '29', '0', '5', '1', NULL, '30,00', '15', '450', '15/06/2020', '5', '51,24', '1024.8', '973,56', '2', NULL),
(28, '00001', '30', '0', '5', '1', NULL, '25,90', '15', '388.5', '15/06/2020', '5', '51,24', '1024.8', '973,56', '2', NULL),
(29, '00001', '31', '0', '5', '1', NULL, '18,63', '10', '186.299999', '15/06/2020', '5', '51,24', '1024.8', '973,56', '2', NULL),
(51, '00002', '29', '9', '15', '1', NULL, '30,00', '15', '450', '15/06/2020', '1', '15,11', '1511', '1.495,89', '1', 'SIM'),
(52, '00002', '30', '9', '15', '1', NULL, '25,90', '5', '129.5', '15/06/2020', '1', '15,11', '1511', '1.495,89', '1', 'SIM'),
(53, '00002', '31', '9', '15', '1', NULL, '18,63', '50', '931.5', '15/06/2020', '1', '15,11', '1511', '1.495,89', '1', 'SIM'),
(54, '00003', '29', '9', '15', '3', NULL, '30,00', '1', '30', '15/06/2020', '1', '0,745', '74.53', '73,785', '', 'SIM'),
(55, '00003', '30', '9', '15', '3', NULL, '25,90', '1', '25.9', '15/06/2020', '1', '0,745', '74.53', '73,785', '', 'SIM'),
(56, '00003', '31', '9', '15', '3', NULL, '18,63', '1', '18.63', '15/06/2020', '1', '0,745', '74.53', '73,785', '', 'SIM'),
(57, '00004', '29', '10', '12', '0', NULL, '35,00', '10', '350', '15/06/2020', '5', '49,216', '984.325', '935,109', '1', NULL),
(58, '00004', '30', '10', '12', '0', NULL, '25,90', '15.5', '401.45', '15/06/2020', '5', '49,216', '984.325', '935,109', '1', NULL),
(59, '00004', '31', '10', '12', '0', NULL, '18,63', '12.5', '232.875', '15/06/2020', '5', '49,216', '984.325', '935,109', '1', NULL),
(60, '00005', '29', '8', '5', '3', NULL, '30,00', '15', '450', '15/06/2020', '12', '178,866', '1490.55', '1.311,684', '', NULL),
(61, '00005', '30', '8', '5', '3', NULL, '25,90', '15', '388.5', '15/06/2020', '12', '178,866', '1490.55', '1.311,684', '', NULL),
(62, '00005', '31', '8', '5', '3', NULL, '18,63', '35', '652.05', '15/06/2020', '12', '178,866', '1490.55', '1.311,684', '', NULL),
(63, '00006', '29', '10', '5', '3', NULL, '30,00', '15', '450', '15/06/2020', '1', '11,18', '1117.95', '1.106,771', '1', NULL),
(64, '00006', '30', '10', '5', '3', NULL, '25,90', '15', '388.5', '15/06/2020', '1', '11,18', '1117.95', '1.106,771', '1', NULL),
(65, '00006', '31', '10', '5', '3', NULL, '18,63', '15', '279.45', '15/06/2020', '1', '11,18', '1117.95', '1.106,771', '1', NULL);
...
CREATE TABLE `produto` (
  ...
  `Preco_Unidade` varchar(20) DEFAULT NULL,
  `Status` varchar(15) DEFAULT NULL,
  `Peso_produto` varchar(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `produto` (`Id`, `Descricao`, `Unidade`, `Preco_Unidade`, `Status`, `Peso_produto`) VALUES
(29, 'Queijo Coalho', NULL, '30,00', 'Disponível', ''),
(30, 'Leite liquido', NULL, '25,90', 'Disponível', ''),
(31, 'Linguiça', NULL, '18,63', 'Disponível', '');
...
(1, 'Vendedor', 'Pessoas que irão realizar vendas '),
(2, 'Administrador', 'Administradores do Sistema ');

-- --------------------------------------------------------

--
-- Estrutura da tabela `titulos_a_pagar`
--

CREATE TABLE `titulos_a_pagar` (
  `Id` smallint(6) NOT NULL,
  `Codigo` varchar(100) DEFAULT NULL,
  `Vencimento` varchar(20) DEFAULT NULL,
  `Baixa` varchar(4) DEFAULT NULL,
  `Data_Baixa` varchar(20) DEFAULT NULL,
  `Id_Compra` varchar(25) DEFAULT NULL,
  `Valor` varchar(16) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `titulos_a_pagar`
--

INSERT INTO `titulos_a_pagar` (`Id`, `Codigo`, `Vencimento`, `Baixa`, `Data_Baixa`, `Id_Compra`, `Valor`) VALUES
(1046, '789658', '12/06/2020', NULL, NULL, '00001', '3850'),
(1047, '4334543', '20/06/2020', NULL, NULL, '00001', '3850');

-- --------------------------------------------------------

--
-- Estrutura da tabela `titulos_a_receber`
--

CREATE TABLE `titulos_a_receber` (
  `Id` smallint(6) NOT NULL,
...
--
-- Extraindo dados da tabela `titulos_a_receber`
--

INSERT INTO `titulos_a_receber` (`Id`, `Codigo`, `Vencimento`, `Baixa`, `Data_Baixa`, `Id_Venda`, `Valor`, `Estorno`) VALUES
(18, NULL, '15/06/2020', NULL, NULL, '00001', '486,78', ''),
(19, NULL, '30/06/2020', NULL, NULL, '00001', '486,78', ''),
(28, NULL, '31/07/2020', NULL, NULL, '00002', '1.495,89', 'SIM'),
(29, NULL, '', NULL, NULL, '00003', '', 'SIM'),
(30, NULL, '', NULL, NULL, '00004', '935,109', NULL),
(31, NULL, '', NULL, NULL, '00005', '', NULL),
(32, NULL, '', NULL, NULL, '00006', '1.106,771', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `unidade_medicao`
--

CREATE TABLE `unidade_medicao` (
  `Id` smallint(6) NOT NULL,
  `unidade` varchar(10) DEFAULT NULL,
  `descricao` varchar(455) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Extraindo dados da tabela `unidade_medicao`
--

INSERT INTO `unidade_medicao` (`Id`, `unidade`, `descricao`) VALUES
(1, 'g', 'Grama'),
(2, 'kg', 'Quilograma'),
(3, 'l', 'Litro'),
(4, 'un', 'Unidade'),
...
(12, 'Vendedor', 'teste@gmail.com', 'Vendedor', '$2y$10$96f6f1uhnvLfKVKcWj5zW.M1V2.iqYQZnR4nFTMQn12vRAzk8xl56', '2020-06-08 14:40:44', '2020-06-08 15:30:41', '1', 'Sim', '999.999.999-32', '10'),
(3, 'Aralyne', 'aralyne@hotmail.com', 'Aralyne', '$2y$10$lp5dVksdkUYu6Gxzn4.BYuG/zt/rHwNMvY3pdmVp1M6yTvQL3BPz2', '0000-00-00 00:00:00', '2020-06-08 14:58:22', '2', 'Sim', '094.976.564-32', NULL),
(5, 'Luiz Felipe Alves Costa', 'Felipealves_98@hotmail.com', 'Felipe', '$2y$10$IS70X.Ps9/h49TUSmhwhGOD7j8f.Mbd7U7qvkHfWrU6OK.LKlM.oO', '2020-06-08 11:34:41', '2020-06-08 14:59:32', '2', 'Sim', '021.456.786-35', '28'),
(15, 'teste ', 'teste@gmail.com', 'teste de teste ', '$2y$10$r7IFHSBwumk6o2ntcrxOoe/LNYyJlFf1ttCxe7VV1tF1F7X/F3WKG', '2020-06-08 15:33:11', '2020-06-15 08:34:02', '1', 'Sim', '05263254863', '15');
...
--
-- Indexes for table `condicao_pag`
--
ALTER TABLE `condicao_pag`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `historico_alt_preco`
--
ALTER TABLE `historico_alt_preco`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `historico_compra`
--
ALTER TABLE `historico_compra`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `historico_vendas`
--
...
--
-- Indexes for table `titulos_a_pagar`
--
ALTER TABLE `titulos_a_pagar`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `titulos_a_receber`
--
ALTER TABLE `titulos_a_receber`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `unidade_medicao`
--
ALTER TABLE `unidade_medicao`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `condicao_pag`
--
ALTER TABLE `condicao_pag`
...
--
-- AUTO_INCREMENT for table `historico_alt_preco`
--
ALTER TABLE `historico_alt_preco`
  MODIFY `Id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `historico_compra`
--
ALTER TABLE `historico_compra`
  MODIFY `Id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2060;
--
-- AUTO_INCREMENT for table `historico_vendas`
--
ALTER TABLE `historico_vendas`
...
--
-- AUTO_INCREMENT for table `titulos_a_pagar`
--
ALTER TABLE `titulos_a_pagar`
  MODIFY `Id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1048;
--
-- AUTO_INCREMENT for table `titulos_a_receber`
--
ALTER TABLE `titulos_a_receber`
  MODIFY `Id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `unidade_medicao`
--
ALTER TABLE `unidade_medicao`
